...
export const auth = betterAuth({
	...
	account: {
		accountLinking: {
			...
			// Allow linking a different Google account for Drive (e.g. work vs personal)
	...
	socialProviders: {
		google: {
			...
			// Drive scope is only requested when user connects Google Drive in Settings → Integrations
			scope: ["email", "profile"],
		},
		github: {
