...
If you are upgrading this project to this version, you need to update the way your prisma client is generated:
...
If you are updating an existing project, work through the following steps to align with the new Next.js 16 defaults and project conventions:
...
See https://nextjs.org/docs/app/guides/upgrading/version-16 for full migration guide (beyond this codebase).
